...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    if (typeof(witnesses_0.approvalSecret) !== 'function') {
      throw new __compactRuntime.CompactError('first (witnesses) argument to Contract constructor does not contain a function-valued field named approvalSecret');
    }
      ...
      approve: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('approve',
                                     ...
                                     'shadow-escrow.compact line 21 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
                                      ...
                                      [
                                       ...
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_1.toValue(0n),
                                                                                              alignment: _descriptor_1.alignment() }).encode() } },
                                       { ins: { cached: false, n: 1 } }]);
    const tmp_0 = this._commitment_0(this._approvalSecret_0(context,
                                                            partialProofData));
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
  ...
  _approvalSecret_0(context, partialProofData) {
    const witnessContext_0 = __compactRuntime.createWitnessContext(ledger(context.currentQueryContext.state), context.currentPrivateState, context.currentQueryContext.address);
    const [nextPrivateState_0, result_0] = this.witnesses.approvalSecret(witnessContext_0);
    context.currentPrivateState = nextPrivateState_0;
    if (!(result_0.buffer instanceof ArrayBuffer && result_0.BYTES_PER_ELEMENT === 1 && result_0.length === 32)) {
      __compactRuntime.typeError('approvalSecret',
                                 'return value',
                                 'shadow-escrow.compact line 11 char 1',
                                 'Bytes<32>',
                                 result_0)
    }
  ...
  _approve_0(context, partialProofData) {
    ...
    __compactRuntime.assert(this._equal_0(_descriptor_2.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                                    ...
                                                                                                    [
                                                                                                     ...
                                                                                                     { popeq: { cached: false,
                                                                                                                result: undefined } }]).value),
                                          this._commitment_0(this._approvalSecret_0(context,
                                                                                    partialProofData))),
  ...
  _commitment_0(secret_0) {
    return this._persistentHash_0([new Uint8Array([115, 104, 97, 100, 111, 119, 45, 101, 115, 99, 114, 111, 119, 58, 97, 112, 112, 114, 111, 118, 97, 108, 58, 118, 49, 0, 0, 0, 0, 0, 0, 0]),
                                   secret_0]);
  }
  _equal_0(x0, y0) {
...
const _dummyContract = new Contract({ approvalSecret: (...args) => undefined });
export const pureCircuits = {
  commitment: (...args_0) => {
    if (args_0.length !== 1) {
      throw new __compactRuntime.CompactError(`commitment: expected 1 argument (as invoked from Typescript), received ${args_0.length}`);
    }
    const secret_0 = args_0[0];
    if (!(secret_0.buffer instanceof ArrayBuffer && secret_0.BYTES_PER_ELEMENT === 1 && secret_0.length === 32)) {
      __compactRuntime.typeError('commitment',
                                 'argument 1',
                                 'shadow-escrow.compact line 34 char 1',
                                 'Bytes<32>',
                                 secret_0)
    }
    return _dummyContract._commitment_0(secret_0);
  }
};
